...
{
    ui->setupUi(this);
    workThread = new CaffeSSDThread();//MODEL_FILE,WEIGHT_FILE,MEAN_FILE,MEAN_VALUE);
    ...
    connect(workThread,&CaffeSSDThread::frameProcessed,this,&MainWindow::dispProcessResults);
